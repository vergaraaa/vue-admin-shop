      ...
      <div class="mt-2 sm:mt-0 sm:flex md:order-2">
        ...
        <template v-if="authStore.isAuthenticated">
          ...
          <button
            ...
            class="mr-10 hidden bg-blue-700 py-1.5 px-6 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 md:mr-0 md:inline-block rounded-lg"
          >
            Logout
          </button>
        </template>
